...
type Usage struct {
	...
	// The usage amount
	Usage float64 `gorm:"not null" db:"usage" json:"usage"`

	// The subscription identifier
	SubscriptionID *string `gorm:"type:uuid;not null;index:usage_subscription_resourcetype,unique" db:"subscription_id" json:"-"`

	// The resource type identifier
	ResourceTypeID *string `gorm:"type:uuid;not null;index:usage_subscription_resourcetype,unique" db:"resource_type_id" json:"-"`
